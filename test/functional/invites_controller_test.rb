...
class InvitesControllerTest < ActionController::TestCase
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post :create, invite: { accepted: @invite.accepted, code: @invite.code, created: @invite.created, email: @invite.email }
    end
  ...
  test "should update invite" do
    put :update, id: @invite, invite: { accepted: @invite.accepted, code: @invite.code, created: @invite.created, email: @invite.email }
    assert_redirected_to invite_path(assigns(:invite))
  end
